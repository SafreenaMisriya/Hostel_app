 ...
 final List<TextInputFormatter>? inputFormatters;
  const CustomTextFormField(
      ...
      this.readOnly,
        ...
        this.contentPadding, this.borderColor, this.onFieldSubmitted, this.maxLines, this.height, this.validator, this.obscureText, this.keyboardType, this.width, this.inputFormatters,
      });
