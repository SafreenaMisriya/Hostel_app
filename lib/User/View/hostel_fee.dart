    ...
    if (userData != null) {
      ...
      FirebaseFirestore.instance
        ...
        if (challanSnapshot.docs.isNotEmpty) {
          setState(() {
            challanData = challanSnapshot.docs.first.data() as Map<String, dynamic>?;
            isLoading = false;
          });
        } else {
          setState(() {
          ...
          return pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Text('Payment Details', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
                pw.SizedBox(height: 10),
                pw.Container(
                    ...
                    children: [
                      ...
                      pw.Row(
                        ...
                        children: [
                          ...
                          pw.Text('${challanData?["parkingCharges"] ?? '100'}/- PKR'),
                        ],
                      ),
                      pw.Row(
                        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          pw.Text('${challanData?["electricityFee"] ?? '100'}/- PKR'),
                        ],
                      ),
                      pw.Row(
                        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          pw.Text('${challanData?["waterCharges"] ?? '100'}/- PKR'),
                        ],
                      ),
                      pw.Row(
                        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          pw.Text('${challanData?["roomCharges"] ?? '5000'}/- PKR'),
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text('Month Fee:', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                    pw.Text('${challanData?["amount"] ?? '10300'}/- PKR', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                  ],
                ),
                pw.SizedBox(height: 20),
