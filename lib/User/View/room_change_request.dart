  ...
  Future<void> submitRequest() async {
    ...
    if (user != null) {
      ...
      if (newBlock != null &&
        ...
        if (newBlock == currentBlockController.text && newRoomNo == currentRoomNoController.text) {
          setState(() {
            isSubmitting = false;
          });
        ...
        DocumentReference docRef = await FirebaseFirestore.instance.collection('roomchangerequest').add({
              ...
              children: [
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    items: ['A', 'B', 'C'].map((block) => DropdownMenuItem(
                      value: block,
                      child: Text(block),
                    )).toList(),
                  ),
